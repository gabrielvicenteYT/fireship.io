...
{{< file "typescript" "index.ts" >}} {{< highlight typescript >}} import lang
...
A Dart [List](https://www.dartlang.org/guides/language/language-tour#lists) is
...
await for (int i in items) { // do something }
