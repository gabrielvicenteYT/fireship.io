...
Option A - Authenticate with _gapi_, then login to Firebase manually with the
...
When the user logs in for the first time, you should see a consent screen that
