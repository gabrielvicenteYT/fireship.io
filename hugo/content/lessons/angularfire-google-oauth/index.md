...
Organizing our user authentication as an injectable service provides code reuse
...
A useful UX feature is to protect routes based on the user's auth state. Now
