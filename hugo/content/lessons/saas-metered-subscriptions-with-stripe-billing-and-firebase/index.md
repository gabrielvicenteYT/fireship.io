...
The first milestone is to get a Firebase user signed up with a Stripe customer
ID.
...
The other important line of code is `httpsCallable('startSubscription')` - it is
