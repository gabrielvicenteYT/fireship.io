...
A Test Bed creates an Angular testing module, which is just a class an NgModule
...
You can see if a string contains a substring, or if an array contains a specific
element.
